export const Icons = {
  whatsapp: {
    paths: [
      {
        d: "M16.75 14.5a.89.89 0 0 1-1.3-.2l-.65-.9a.89.89 0 0 1-.2-1.3l.9-.65a.89.89 0 0 1 1.3-.2l.65.9a.89.89 0 0 1 .2 1.3l-.9.65ZM12 2C6.477 2 2 6.477 2 12c0 1.956.577 3.896 1.666 5.485L2 22l4.515-1.666A9.954 9.954 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2Zm3.475 14.341c-.482.482-1.12.723-1.8.723-.68 0-1.318-.241-1.8-.723-.482-.482-.723-1.12-.723-1.8s.241-1.318.723-1.8c.482-.482 1.12-.723 1.8-.723.68 0 1.318.241 1.8.723s.723 1.12.723 1.8-.241 1.318-.723 1.8Z",
      },
      {
        d: "M12 2C6.477 2 2 6.477 2 12c0 1.956.577 3.896 1.666 5.485L2 22l4.515-1.666A9.954 9.954 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2Zm3.475 14.341c-.482.482-1.12.723-1.8.723-.68 0-1.318-.241-1.8-.723-.482-.482-.723-1.12-.723-1.8s.241-1.318.723-1.8c.482-.482 1.12-.723 1.8-.723.68 0 1.318.241 1.8.723s.723 1.12.723 1.8-.241 1.318-.723 1.8Z",
      },
    ],
    class: "h-8 w-8 shrink-0 fill-current", // Ajusta el tamaño y el fill-current para que tome el color del padre
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
  },
  instagram: {
    paths: [
      {
        d: "M12 0c-3.235 0-3.633.013-4.907.076-1.282.065-2.146.26-2.903.546-.777.294-1.442.705-2.107 1.37-.665.665-1.076 1.33-1.37 2.107-.286.757-.481 1.621-.546 2.903C.013 8.367 0 8.765 0 12s.013 3.633.076 4.907c.065 1.282.26 2.146.546 2.903.294.777.705 1.442 1.37 2.107.665.665 1.33 1.076 2.107 1.37.757.286 1.621.481 2.903.546C8.367 23.987 8.765 24 12 24s3.633-.013 4.907-.076c1.282-.065 2.146-.26 2.903-.546.777-.294 1.442-.705 2.107-1.37.665-.665 1.076-1.33 1.37-2.107.286-.757.481-1.621.546-2.903.063-1.274.076-1.672.076-4.907s-.013-3.633-.076-4.907c-.065-1.282-.26-2.146-.546-2.903-.294-.777-.705-1.442-1.37-2.107C21.442 1.076 20.777.665 20 0.37c-.757-.286-1.621-.481-2.903-.546C15.633.013 15.235 0 12 0zm0 2.16c3.208 0 3.584.012 4.857.075 1.171.06 1.839.245 2.228.396.38.147.625.32.969.664.344.344.517.589.664.969.15.389.336 1.057.396 2.228.063 1.273.075 1.65.075 4.857s-.012 3.584-.075 4.857c-.06 1.171-.245 1.839-.396 2.228-.147.38-.32.625-.664.969-.344.344-.589.517-.969.664-.389.15-.99.336-2.228.396-1.273.063-1.65.075-4.857.075s-3.584-.012-4.857-.075c-1.171-.06-1.839-.245-2.228-.396-.38-.147-.625-.32-.969-.664-.344-.344-.517-.589-.664-.969-.15-.389-.336-1.057-.396-2.228C2.253 15.633 2.16 15.257 2.16 12s.012-3.584.075-4.857c.06-1.171.245-1.839.396-2.228.147-.38.32-.625.664-.969.344-.344.589-.517.969-.664.389-.15.99-.336 2.228-.396C8.416 2.253 8.792 2.16 12 2.16zm0 3.66c-3.136 0-5.68 2.544-5.68 5.68s2.544 5.68 5.68 5.68 5.68-2.544 5.68-5.68-2.544-5.68-5.68-5.68zm0 2.16c1.944 0 3.52 1.576 3.52 3.52s-1.576 3.52-3.52 3.52-3.52-1.576-3.52-3.52 1.576-3.52 3.52-3.52zm6.26-6.17a1.41 1.41 0 0 1 1.41-1.41 1.41 1.41 0 0 1 1.41 1.41 1.41 1.41 0 0 1-1.41 1.41 1.41 1.41 0 0 1-1.41-1.41z",
      },
    ],
  ...
  house: {
    ...
    class:
      "h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-[#212121] dark:text-neutral-300 dark:hs-tab-active:text-orange-300 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowUp: {
    ...
    class: "h-5 w-5 shrink-0 text-[#212121] dark:text-orange-300",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
