...
head:
  - tag: title
    content: Extintoresdelrisaralda docs
...
hero:
  ...
  image:
      alt: A Extintoresdelrisaralda's Logo
  ...
  actions:
    ...
    - text: View on GitHub
      icon: external
      variant: minimal
      link: https://github.com/mearashadowfax/Extintoresdelrisaralda
---
...
<CardGrid stagger>
  ...
  <Card title="Outils et Équipements" icon="seti:eslint">
    Découvrez la gamme complète d'outils et d'équipements de qualité supérieure de Extintoresdelrisaralda. Chaque sous-section offre des spécifications détaillées, des instructions d'utilisation et des conseils de maintenance.
  </Card>
