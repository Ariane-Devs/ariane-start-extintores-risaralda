...
export const partnersData = [
    {
        icon: '<img src="/src/images/partners/partner1.png" alt="Partner 1" class="mx-auto h-auto w-40 py-3 sm:mx-0 lg:w-70 lg:py-5" />',
        name: "First",
        href: "#",
    },
    {
        icon: '<img src="/src/images/partners/partner2.png" alt="Partner 2" class="mx-auto h-auto w-36 py-3 sm:mx-0 lg:w-50 lg:py-5" />',
        name: "Second",
        href: "#",
    },
    {
        icon: '<img src="/src/images/partners/partner3.png" alt="Partner 3" class="mx-auto h-auto w-30 py-3 sm:mx-0 lg:w-40 lg:py-5" />',
        name: "Third",
        href: "#",
    },
    {
        icon: '<img src="/src/images/partners/partner4.png" alt="Partner 4" class="mx-auto h-auto w-32 py-3 sm:mx-0 lg:w-50 lg:py-5" />',
        name: "Fourth",
        href: "#",
    },
]